...
const UUID = process.env.UUID || '310df915-93ed-40cb-a279-f3d2cb8cb43e'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'subjh0112';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'subjh0112';                       // 节点名称
